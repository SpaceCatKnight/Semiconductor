...
\end{figure}
%
Aus der obigen Tabelle ist ersichtlich, dass der Zusammenhang zwischen Temperatur $T$ und der Thermospannung $V$ linear ist. Es gilt
\begin{equation}
T = c_1 V + c_2
\end{equation}
...
\end{align*}
 ...
 \begin{equation}
 T = c_1 \left(V+ \frac{T_1-c_2}{c_1}\right)+c_2= c_1 V + T_1
 \end{equation}
